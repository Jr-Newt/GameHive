                            ...
                            echo '<table class="table table-bordered table-striped">';
                                ...
                                while($row = $result->fetch()){
                                    echo "<tr>";
                                        ...
                                        echo "<td>" . $row['gearcat'] . "</td>";
                                        echo "<td>" . $row['gearimage'] . "</td>";
                                        echo "<td>";
                                            echo '<a href="gearread.php?id='. $row['id'] .'" class="mr-0" title="View Record" data-toggle="tooltip"><span class="fa fa-eye"></span></a>';
                                            echo '<a href="gearupdate.php?id='. $row['id'] .'" class="mr-0" title="Update Record" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
                                            echo '<a href="geardelete.php?id='. $row['id'] .'" title="Delete Record" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";
