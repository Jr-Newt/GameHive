<?php
session_start();
$con = mysqli_connect('localhost', 'root', '', 'gamehive');
$email = "";
$name = "";
$errors = array();
...
if(isset($_POST['signup'])){
    ...
    if(count($errors) === 0){
        ...
        $status = "notverified";
        $insert_data = "INSERT INTO registration (firstname,lastname, email, password, code, status)
                        values('$firstname', '$lastname', '$email', '$encpass', '$code', '$status')";
        $data_check = mysqli_query($con, $insert_data);
        if($data_check){
            $subject = "Email Verification Code";
            $message = "Your verification code is $code";
            $sender = "From: issacwilsonkureekkattil@gmail.com";
